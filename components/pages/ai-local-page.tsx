...
const RunningAILocallyArticle = () => {
  ...
  return (
    <section className="w-full bg-black mt-20 py-20 px-4 sm:px-8 lg:px-16">
      <div className="max-w-7xl mx-auto">
        {/* Back Button */}
        <motion.button
          className="flex items-center space-x-2 text-white hover:text-blue-700 transition-all duration-300 mb-8"
        ...
        {/* Author and Date */}
        <motion.div
          className="flex items-center space-x-4 text-white mb-12"
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
        ...
        <div className="space-y-12">
          ...
          >
            <h2 className="text-3xl font-bold text-white">Why Run AI Locally?</h2>
            <p className="text-lg text-white">
